$(document).ready(function(){
	...
	$('#question_type_2').change(function(e){
		...
		if ($('#question_type_2').val()=="short_text") {
			...
			$('#type_answer_2').html("<input type='checkbox'/><input type='text' id='option_20' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_21' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_22' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_23' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_2').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_3').change(function(e){
		...
		if ($('#question_type_3').val()=="short_text") {
			...
			$('#type_answer_3').html("<input type='checkbox'/><input type='text' id='option_30' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_31' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_32' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_33' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_3').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_4').change(function(e){
		...
		if ($('#question_type_4').val()=="short_text") {
			...
			$('#type_answer_4').html("<input type='checkbox'/><input type='text' id='option_40' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_41' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_42' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_43' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_4').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_5').change(function(e){
		...
		if ($('#question_type_5').val()=="short_text") {
			...
			$('#type_answer_5').html("<input type='checkbox'/><input type='text' id='option_50' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_51' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_52' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_43' size='53' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_5').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_6').change(function(e){
		...
		if ($('#question_type_6').val()=="short_text") {
			...
			$('#type_answer_6').html("<input type='checkbox'/><input type='text' id='option_60' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_61' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_62' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_63' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_6').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_7').change(function(e){
		...
		if ($('#question_type_7').val()=="short_text") {
			...
			$('#type_answer_7').html("<input type='checkbox'/><input type='text' id='option_70' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_71' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_72' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_73' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_7').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_8').change(function(e){
		...
		if ($('#question_type_8').val()=="short_text") {
			...
			$('#type_answer_8').html("<input type='checkbox'/><input type='text' id='option_80' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_81' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_82' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_83' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_8').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_9').change(function(e){
		...
		if ($('#question_type_9').val()=="short_text") {
			...
			$('#type_answer_9').html("<input type='checkbox'/><input type='text' id='option_90' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_91' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_92' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_93' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_9').css({
				'display' : 'none'
			});
		}
	...
	$('#question_type_10').change(function(e){
		...
		if ($('#question_type_10').val()=="short_text") {
			...
			$('#type_answer_10').html("<input type='checkbox'/><input type='text' id='option_100' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_101' size='43' maxlength='40' placeholder='Choice'/><br/><br/><input type='checkbox'/><input type='text' id='option_102' size='43' maxlength='40' placeholder='Choice (optional)'/><br/><br/><input type='checkbox'/><input type='text' id='option_103' size='43' maxlength='40' placeholder='Choice (optional)'/>");
			$('#add_answer_10').css({
				'display' : 'none'
			});
		}
